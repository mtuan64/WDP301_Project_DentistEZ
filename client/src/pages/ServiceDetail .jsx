...
const ServiceDetail = () => {
  ...
  const getCurrentPrice = () => {
    ...
    return currentOption ? Number(currentOption.price) : '';
  };

  const handleBooking = () => {
    if (!selectedOption || !selectedDate || !selectedTimeSlot) {
            ...
            <div style={styles.optionSection}>
              ...
              >
                ...
                {options.map((option, index) => (
                  <option
                    key={option._id || option.optionName || option.name || index}
                  ...
                  {!selectedDate ? (
                    ...
                    slots.map((slot, index) => (
                      <div
                        ...
                        style={{
                          ...styles.timeSlot,
                          ...(selectedTimeSlot === (slot.time || slot.start_time)
                            ? styles.timeSlotSelected
                            : {}),
                          ...((slot.available === false || slot.isAvailable === false)
                            ? styles.timeSlotDisabled
                            : {})
                        }}
                        onClick={() =>
                          (slot.available !== false && slot.isAvailable !== false) &&
                          setSelectedTimeSlot(slot.time || slot.start_time)
                        }
                      >
                        {slot.time
                          ? slot.time
