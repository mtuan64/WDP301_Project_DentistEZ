...
router.post(
  "/admin/create-account-doctor",
  authAdminMiddleware,
  createAcountDoctor
);
router.get("/clinic", getAllClinic);
router.post(
  "/admin/create-account-staff",
  authAdminMiddleware,
  createAcountStaff
);
...
router.patch(
  "/admin/update-status/:role/:recordId",
  authAdminMiddleware,
  changeStatus
);
...
router.get("/payment/:orderCode", getPaymentByOrderCode);
